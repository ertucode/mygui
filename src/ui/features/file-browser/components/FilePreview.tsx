...
export function FilePreview({ filePath, isFile, fileSize, fileExt, isResizing = false }: FilePreviewProps) {
  ...
  const previewUrl =
    import.meta.env.MODE === 'development'
      ? 'http://localhost:5123/preview.html?window-args=' + getWindowElectron().getWindowArgs()
